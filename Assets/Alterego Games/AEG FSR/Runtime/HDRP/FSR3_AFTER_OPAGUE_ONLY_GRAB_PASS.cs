...
namespace AEG.FSR
{
    public class FSR3_AFTER_OPAGUE_ONLY_GRAB_PASS : CustomPass
    {
        ...
        protected override void Execute(CustomPassContext ctx) {
            ...
            ctx.cmd.Blit(ctx.cameraColorBuffer, m_hdrp.m_afterOpaqueOnlyColorBuffer, ctx.cameraColorBuffer.rtHandleProperties.rtHandleScale, vector2Zero, 0, 0);
