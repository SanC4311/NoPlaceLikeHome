    ...
    public class ListEditor : Editor
    {
        ...
        void NormalItemSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showNormalItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(normalItemTextMaterial, myTarget.NormalTextMaterial, "Text", variableName + "NormalTextMaterial");
                MText_Editor_Methods.PriviewField(normalItemBackgroundMaterial, myTarget.NormalBackgroundMaterial, "Background", variableName + "NormalBackgroundMaterial");
                GUILayout.EndHorizontal();
        ...
        void SelectedItemSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showSelectedItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(selectedItemTextMaterial, myTarget.SelectedTextMaterial, "Text", variableName + "SelectedTextMaterial");
                MText_Editor_Methods.PriviewField(selectedItemBackgroundMaterial, myTarget.SelectedBackgroundMaterial, "Background", variableName + "SelectedBackgroundMaterial");
                GUILayout.EndHorizontal();
        ...
        void PressedItemSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showPressedItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(pressedItemTextMaterial, myTarget.PressedTextMaterial, "Text", variableName + "PressedTextMaterial");
                MText_Editor_Methods.PriviewField(pressedItemBackgroundMaterial, myTarget.PressedBackgroundMaterial, "Background", variableName + "PressedBackgroundMaterial");
                GUILayout.EndHorizontal();
        ...
        void DisabledItemSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showDisabledItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(disabledItemTextMaterial, myTarget.DisabledTextMaterial, "Text", variableName + "DisabledTextMaterial");
                MText_Editor_Methods.PriviewField(disabledItemBackgroundMaterial, myTarget.DisabledBackgroundMaterial, "Background", variableName + "DisabledBackgroundMaterial");
                GUILayout.EndHorizontal();
