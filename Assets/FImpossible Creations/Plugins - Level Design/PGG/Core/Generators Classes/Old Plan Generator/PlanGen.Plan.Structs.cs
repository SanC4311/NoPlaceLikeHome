...
namespace FIMSpace.Generating
{
    ...
    public partial class PlanHelper
    {
        public struct HelperRect
        {
            ...
            public bool HaveConnectionWithCorridor()
            {
            ...
            public bool HaveConnectionWith(HelperRect tgtRect)
            {
                if (Connections == null) return false;
            ...
            /// </summary>
            public void GenerateGraphCells(FGenGraph<FieldCell, FGenPoint> corridorsGraph)
            {
            ...
            /// Converting bounds to grid cells
            /// </summary>
            public List<FieldCell> GenerateGraphCells(bool additionalNeightbourData = false)
            {
        ...
        public struct ConnectionRect
        {
            ...
            public SpawnInstruction GenerateGuide(FieldSetup parentSetup, EHelperGuideType type, bool reverse = false, float mul = 1f)
            {
            ...
            public SpawnInstruction GenerateGuide(FieldSetup parentSetup, SingleInteriorSettings settings, bool reverse = false, float mul = 1f)
            {
                SpawnInstruction guide = new SpawnInstruction
                {
                    helperConnection = this
