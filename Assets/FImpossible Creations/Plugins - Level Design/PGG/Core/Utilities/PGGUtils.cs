...
namespace FIMSpace.Generating
{
    public static class PGGUtils
    {
        ...
        public static void TransferFromListToListI(List<ICheckerReference> from, List<ICheckerReference> to, bool checkForDuplicates = false)
        {
            if (to == null) return;
            if (from == null) return;
        ...
        public static void TransferFromListToListI(List<CheckerField3D> from, List<ICheckerReference> to, bool checkForDuplicates = false)
        {
            if (to == null) return;
            if (from == null) return;
