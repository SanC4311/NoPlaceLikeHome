...
namespace FIMSpace.Generating
{
    ...
    public partial class FieldVariable
    {
        ...
        [SerializeField] private Color colVal;
        ...
        public int GetNameHash
        {
            get
            {
                if (nameHash == 0) nameHash = Name.GetHashCode();
                return nameHash;
            }
        }
        ...
        public enum EVarType { None, Number, Bool, Material, GameObject, Vector3, Vector2, ProjectObject, String, Color, Curve/*, Int, Vector2, String*/ }
        ...
        public Color GetColor() { return colVal; }
        ...
        public AnimationCurve GetCurve() { return curve; }
        ...
        public void SetValue(Color value) { colVal = value; ValueType = EVarType.Color; UpdateVariable(); }
        public void SetValue(AnimationCurve value) { curve = value; ValueType = EVarType.Curve; UpdateVariable(); }
        ...
        public object GetValue()
        {
            if (returnTempRef)
            {
                ...
                if (FGenerators.CheckIfExist_NOTNULL(temporaryReference))
                {
                    if (temporaryReference is NodePortBase)
                    {
                        ...
                        if (port.IsOutput)
                        {
                            if (port is PGGPlannerPort) { PGGPlannerPort pp = port as PGGPlannerPort; return pp.GetNumberedIDArrayVector(); }
            ...
            switch (ValueType)
            {
                ...
                case EVarType.Color: return GetColor();
        ...
        public void SetValue(FieldVariable value)
        {
            ...
            switch (value.ValueType)
            {
                ...
                case EVarType.Color: SetValue(value.GetColor()); break;
