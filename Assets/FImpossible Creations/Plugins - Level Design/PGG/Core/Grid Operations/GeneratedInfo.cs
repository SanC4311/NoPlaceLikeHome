...
namespace FIMSpace.Generating
{
    ...
    public class InstantiatedFieldInfo
    {
        ...
        /// <summary> All instantiated objects by the Field Spawner Setup </summary>
        ...
        /// <summary> Can be null, assigned when generated with defined target parent for generated objects. (parent of FieldTransform) </summary>
        public GameObject MainContainer;
        /// <summary> New generated object which is parent of all generated objects </summary>
        public Transform FieldTransform;

        /// <summary> Grid which was used to generate objects </summary>
        [HideInInspector] public FGenGraph<FieldCell, FGenPoint> Grid;

        /// <summary> Bounding box, generated out of all meshes of instantiated objects </summary>
        ...
        /// <summary> Null if parent Field Setup is not using combaining </summary>
        public GameObject CombinedStaticContainer { get; internal set; }
        /// <summary> Null if parent Field Setup is not using combaining </summary>
        public GameObject CombinedNonStaticContainer { get; internal set; }
        ...
        public void Clear(bool destroyAll)
        {
            if (Instantiated == null) Instantiated = new List<GameObject>();
        ...
        public CellInstanitations GetInfoAt(Vector3Int parentCellPos)
        {
        ...
        public bool ReplaceWith(FieldCell cellSpawnData, CellsController generatingController)
        {
