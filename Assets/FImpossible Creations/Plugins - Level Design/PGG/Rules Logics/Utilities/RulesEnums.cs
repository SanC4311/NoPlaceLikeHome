...
namespace FIMSpace.Generating.Rules
{
    ...
    public static class SpawnRules
    {
        ...
        public static SpawnData GetNearest(FieldCell cell, Vector3 wpos, FieldSetup forNearestCheck, float maxDistance = 1000f, System.Func<SpawnData, bool> iterationCondition = null)
        {
            var spawns = cell.CollectSpawns();
