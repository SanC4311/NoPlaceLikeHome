...
namespace FIMSpace.Generating
{
    ...
    public class NeightbourPlacement
    {
        ...
        public ENeightbour GetFirstSelectedNeightbourID(float yawOffset)
        {
        ...
        public ENeightbour Get360NeightbourID(int rotCC)
        {
        ...
        public int Get360NeightbourID(ENeightbour rotCC)
        {
        ...
        public ENeightbour GetFirstSelectedNeightbourID()
        {
        ...
        public void Set(ENeightbour n, bool v)
        {
            switch (n)
            {
