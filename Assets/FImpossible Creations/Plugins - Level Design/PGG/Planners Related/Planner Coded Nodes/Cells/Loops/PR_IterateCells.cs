...
namespace FIMSpace.Generating.Planning.PlannerNodes.Cells.Loops
{
    ...
    public class PR_IterateCells : PlannerRuleBase
    {
        ...
        [HideInInspector][Port(EPortPinType.Input, EPortNameDisplay.Default, 1)] public PGGPlannerPort CellsOf;
        ...
        public override void Editor_OnNodeBodyGUI(ScriptableObject setup)
        {
            ...
            BreakLoop.AllowDragWire = false;

            if (!_EditorFoldout) return;

            CellsOf.AllowDragWire = true;
            BreakLoop.AllowDragWire = true;
