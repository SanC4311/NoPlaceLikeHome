...
namespace FIMSpace.Generating.Planning.PlannerNodes.Math.Algebra
{
    ...
    public class PR_ABS : PlannerRuleBase
    {
        public override string GetDisplayName(float maxWidth = 120) { return wasCreated ? "Always Positive (Abs)" : "Always Positive (Absolute Value Abs)"; }
        public override Color GetNodeColor() { return new Color(0.3f, 0.5f, 0.75f, 0.9f); }
        public override Vector2 NodeSize { get { return new Vector2(176, 82); } }
