    ...
    public partial class FieldSetupComposition
    {
        ...
        public class PackOverrideHelper
        {
            ...
            public void ReInitializeWith(ModificatorsPack pack)
            {
                ...
                if (ParentPack.FieldModificators != null)
            ...
            public void AdjustFieldSetupVariables()
            {
        ...
        public void RefreshPlannerVariablesCount(List<FieldVariable> variables)
        {
        ...
        public class ModOverrideHelper
        {
            ...
            public void UpdateModsCountWith(FieldModification fieldModification)
            {
                ParentMod = fieldModification;
                if (OverridePrefabs == null) OverridePrefabs = new List<PrefabReference>();
                if (fieldModification == null) return;
        ...
        public void AdjustModPacksCount()
        {
        ...
        public void AdjustUtilityModsCount()
        {
        ...
        public FieldSetup GetOverridedSetup()
        {
            FieldSetup nSetup;
            ...
            if (GenType == EPGGGenType.FieldSetup)
            {
                ...
                for (int u = 0; u < Setup.UtilityModificators.Count; u++)
                {
                    ...
                    if (UtilityModsOverrides.ContainsIndex(u))
        ...
        public void RefreshWith(ModificatorsPack justModPack)
        {
            if (FieldPackagesOverrides == null) FieldPackagesOverrides = new List<PackOverrideHelper>();
            if (FieldPackagesOverrides.Count == 0) FieldPackagesOverrides.Add(null);
