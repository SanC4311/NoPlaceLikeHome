    ...
    public partial class FieldPlanner
    {
        ...
        public void PrepareInitialChecker()
        {
            ...
            else
            {
                ...
                {
                    if (previewChecker == null)
                        previewChecker = ShapeGenerator.GetChecker(this);
                }
            }
        ...
        {
            if (previewChecker == null || previewChecker.ChildPositionsCount == 0)
            {
                if (previewChecker == null) previewChecker = new CheckerField3D();
                //ClearSubFields();
        ...
        public static FieldPlannerReference GenerateReference(FieldPlanner plan, CheckerField3D subField = null)
        {
            FieldPlannerReference fRef = new FieldPlannerReference(plan, subField);
            return fRef;
        }
        ...
        public void RemoveRuleFromPlanner(PlannerRuleBase plannerRuleBase)
        {
