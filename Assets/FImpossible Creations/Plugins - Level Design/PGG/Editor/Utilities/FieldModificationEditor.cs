...
#pragma warning restore IDE0052 // Remove unread private members
                            ...
                            if (spawnersList[selected] != null)
                            {
                                ...
                                if (sp_sp != null)
                                {
                                    ...
                                    if (FieldModification._subDraw == 0)
                                    {
                                        ...
                                        if (GUILayout.Button(GetFoldLeftSprite(sp_next.boolValue), EditorStyles.label, GUILayout.Height(18), GUILayout.Width(22)))
        ...
        static GUIContent GetFoldLeftSprite(bool foldout)
        {
            if (EditorGUIUtility.isProSkin == false) return new GUIContent(foldout ? FGUI_Resources.Tex_DownFold : FGUI_Resources.Tex_LeftFold);
            return foldout ? FGUI_Resources.GUIC_FoldGrayDown : FGUI_Resources.GUIC_FoldGrayLeft;
        }
