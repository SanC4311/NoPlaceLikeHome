        ...
        public bool Editor_DisplayVariableGUI()
        {
            ...
            else if (VariableType == EVariableType.Curve)
            {
                ...
                else
                {
                    ...
                    _curve = EditorGUILayout.CurveField(nameG, GetCurve(), Color.cyan, fixedRect);
                }
            }
            else if (VariableType == EVariableType.Color)
            {
                SetValue(EditorGUILayout.ColorField("Color:", GetColor()));
            }
